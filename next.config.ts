...
const nextConfig: NextConfig = {
  ...
  // Desabilitar source maps em desenvolvimento (corrige erro de fetch)
  ...
  // Desabilitar telemetria e analytics em dev
  experimental: {
    optimizePackageImports: ['lucide-react', '@radix-ui/react-icons'],
  },
  
  // Webpack config para desabilitar source maps em dev
  webpack: (config, { dev, isServer }) => {
    if (dev && !isServer) {
      config.devtool = false; // Desabilita source maps completamente em dev
    }
    return config;
  },
